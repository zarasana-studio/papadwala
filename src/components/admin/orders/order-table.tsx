...
import { columns, type OrderItem } from "./order-columns";
    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex items-center justify-between py-2">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <p className="text-[11px] font-medium text-slate-500">Rows per page</p>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
              ...
              <DropdownMenuContent align="start" className="min-w-[70px] rounded-xl">
